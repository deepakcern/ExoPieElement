  ...
  if( fillFilterInfo_ )
    {
      ...
      patFilterTree_                          = new patFilters("hlt_",tree_,iConfig);
  ...
  if( fillGenInfo_ )
    {
      ...
      genInfoTree_->ak4genJetsToken           = consumes<reco::GenJetCollection>(iConfig.getParameter<edm::InputTag>("genJetLabel"));//(edm::InputTag("ak4GenJetsNoNu"));//"ak4GenJets"));
